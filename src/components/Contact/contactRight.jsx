...
export default function ContactRight({mode}) {
  return (
    <div className='pt-28  w-1/2 pr-8 '  >
      ...
      <textarea style={mode === 'light'?{background:'#1B254A'}:null} name="" placeholder='Your message' id="" cols="30"  className='h-32 border w-full h-11 p-3 overflow-hidden resize-none rounded focus:outline-none'></textarea>
